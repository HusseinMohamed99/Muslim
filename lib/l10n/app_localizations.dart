...
abstract class AppLocalizations {
  ...
  /// No description provided for @sura_number.
  ///
  /// In en, this message translates to:
  /// **'Sura Number'**
  ...
  /// No description provided for @hadith_name.
  ///
  /// In en, this message translates to:
  /// **'Hadith Name'**
  ...
  /// No description provided for @sebha_numbers.
  ///
  /// In en, this message translates to:
  /// **'Sebha Numbers'**
  String get sebha_numbers;

  /// No description provided for @subhan_allah.
  ///
  /// In en, this message translates to:
  /// **'Subhan Allah'**
